...
(_, positive_edges, negative_edges) = count_edge_types(data, 2000, definition_C3, args_for_definition_C(10, 5000))
randomNetwork = RandomNetwork(positive_edges, negative_edges, definition_C3, args_for_definition_C(10, 5000))
random_fractions = fraction_of_embedded_positive_signs(data, 2000, randomNetwork.link_sign,
